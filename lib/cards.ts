...
export const CARD_THEMES: CardTheme[] = [
  { key: 'cream',      label: 'Cream',      gradient: ['#F4EFE6', '#EBE1D2'], textColor: '#2E2A26', refColor: '#B0532F', wordmarkColor: '#A08B76' },
  { key: 'terracotta', label: 'Terracotta', gradient: ['#C0623B', '#9E4526'], textColor: '#FBF3E8', refColor: '#F0C9AE', wordmarkColor: '#F0D5C2' },
  { key: 'dusk',       label: 'Dusk',       gradient: ['#4A5B84', '#2E3350'], textColor: '#F2EFE8', refColor: '#E7C98B', wordmarkColor: '#C9CBDD' },
  { key: 'charcoal',   label: 'Charcoal',   gradient: ['#2B2724', '#171412'], textColor: '#EFE9DF', refColor: '#C79A4B', wordmarkColor: '#8F857A' },
];
